...
ifeq "$(wildcard nbproject/Makefile-local-USB_Bootloaded_HID.mk)" "nbproject/Makefile-local-USB_Bootloaded_HID.mk"
include nbproject/Makefile-local-USB_Bootloaded_HID.mk
endif
endif
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-USB_Bootloaded_HID.mk dist/${CND_CONF}/${IMAGE_TYPE}/nes-snes-replay.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/nes-snes-replay.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    app_32MX250F128B.ld
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/USB_Bootloaded_HID
	${RM} -r dist/USB_Bootloaded_HID
