...
ifeq "$(wildcard nbproject/Makefile-local-NoUSB_Standalone.mk)" "nbproject/Makefile-local-NoUSB_Standalone.mk"
include nbproject/Makefile-local-NoUSB_Standalone.mk
endif
endif
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-NoUSB_Standalone.mk dist/${CND_CONF}/${IMAGE_TYPE}/nes-snes-replay.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/main.o: main.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/main.o.d 
	@${RM} ${OBJECTDIR}/main.o 
	@${FIXDEPS} "${OBJECTDIR}/main.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -ffunction-sections -fdata-sections -mno-float -Os -funroll-loops -fomit-frame-pointer -fschedule-insns -fschedule-insns2 -MMD -MF "${OBJECTDIR}/main.o.d" -o ${OBJECTDIR}/main.o main.c    -G 1024
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/NoUSB_Standalone
	${RM} -r dist/NoUSB_Standalone
